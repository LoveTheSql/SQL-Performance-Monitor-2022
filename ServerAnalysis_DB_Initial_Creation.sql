/* THIS DATABASE is created on each server instance in each location  
	TESTED on SQL 2017+
...
USE [ServerAnalysis]
GO
/****** Object:  DatabaseRole [db_executor]    Script Date: 10/12/2022 10:50:20 AM ******/
CREATE ROLE [db_executor]
GO
/****** Object:  Schema [Analysis]    Script Date: 10/12/2022 10:50:20 AM ******/
CREATE SCHEMA [Analysis]
GO
/****** Object:  UserDefinedFunction [Analysis].[ConvertMsToTime]    Script Date: 10/12/2022 10:50:20 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  UserDefinedFunction [Analysis].[ConvertTicksToTime]    Script Date: 10/12/2022 10:50:20 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [Analysis].[NegToZero]    Script Date: 10/12/2022 10:50:20 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[CreateDateTimeFrom2Strings]    Script Date: 10/12/2022 10:50:20 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [Analysis].[PerfCounterLog]    Script Date: 10/12/2022 10:50:20 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Analysis].[PerfCounterLogActions]    Script Date: 10/12/2022 10:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Analysis].[PerfCounterMetric]    Script Date: 10/12/2022 10:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Analysis].[PerfLocation]    Script Date: 10/12/2022 10:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Analysis].[Server]    Script Date: 10/12/2022 10:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [Analysis].[PerfCounterCleanup]    Script Date: 10/12/2022 10:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [Analysis].[PerfCounterMetricIntervalInsertJob]    Script Date: 10/12/2022 10:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [Analysis].[ServerCurrentUpdate]    Script Date: 10/12/2022 10:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
@RdsS3FileArn varchar(500) =  'arn:aws:s3:::helix-databasee/ssis/test.txt'
AS
BEGIN
	...
	-- If this is an RDS server that failed over, we need to recreate the file directory for D:s3 for our Perf Counter SSIS project.
	if  ((select count(*) from [Analysis].[Server] where ServerNm = @@ServerName and IsCurrent = 1) = 0) and ((SELECT count(*) FROM sys.databases where name = 'rdsadmin') = 1)
	begin 
		-- Update and RECRETE the RDS S3 drive for SSIS, in case its been wiped. We will copy a file from S3
		BEGIN TRY
			EXEC msdb.dbo.rds_download_from_s3 
				 @s3_arn_of_file = @RdsS3FileArn, 
				 @rds_file_path = 'D:\S3\PerfCounter\staged\test.txt', 
				 @overwrite_file = 1;
		END TRY
		BEGIN CATCH
			PRINT 'Object: msdb.dbo.rds_download_from_s3  does nto exist.'
		END CATCH;
	end;
	...
	begin 
		-- Insert the data we currently know
		insert into Analysis.Server ([ServerNm], --[ServerResolvedName], 
			[IsCurrent], LocationID, ClusterID, LocationName, CLusterName)
		Select TOP(1) @@ServerName, --ServerResolvedName, 
			1, LocationID, ClusterID, LocationName, ClusterName
		...
		-- Look up the Future Record stroed for this server ID and get its PerfLocationID
		SELECT 	@PerfLocationID = p.id
		FROM Analysis.PerfLocation p 
			INNER JOIN Analysis.Server s ON p.LocationID = s.LocationID and p.ClusterID = s.ClusterID
		WHERE p.ServerID = @NewServerID and LEFT(p.ServerName,6) = 'FUTURE'
		GROUP BY  p.ID, p.ServerID, p.ClusterName, p.ServerName
		ORDER BY  p.ID, p.ServerID, p.ClusterName, p.ServerName;

		-- Update the Future Record
		UPDATE Analysis.PerfLocation
		SET ServerName = @@ServerName
		WHERE ID = @PerfLocationID;

		-- Since/if we are on the same DB Server let update the main database as well
		--UPDATE ServerAnalysisDW.Analysis.PerfLocation
		--SET ServerName = @@ServerName
		--WHERE ID = @PerfLocationID;
...
GO
/****** Object:  StoredProcedure [dbo].[sp_WhoIsActive]    Script Date: 10/12/2022 10:50:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
